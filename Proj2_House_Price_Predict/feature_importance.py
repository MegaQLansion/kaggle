...
FI=pd.DataFrame({'Feature':Columns,'Importance':FI_lasso})
FI_lasso.to_csv('C:/Users/Administrator/ml_python/ex1/house_price/feature_importance_data.csv', index=False)